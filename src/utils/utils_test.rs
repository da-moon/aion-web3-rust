...
pub mod utils_test {
    ...
    fn from_utf8(){
        let result = "JKL".to_string();
        let result = utils::from_utf8("4a4b4c".to_string());
    ...
    fn from_utf8_alt(){
        let result = "Hello world!".to_string();
        let result = utils::from_utf8("48656c6c6f20776f726c6421".to_string());
        assert_eq!(result, result);
    }
    #[test]
    #[ignore]
    fn from_utf8_with_0x(){
        let result = "JKL".to_string();
        let result = utils::from_utf8("0x4a4b4c".to_string());
        assert_eq!(result, result);
    }
    #[test]
    #[ignore]
    fn from_utf8_odd_len(){
        let result = "JK".to_string();
        let result = utils::from_utf8("0x4a4b4".to_string());
        assert_eq!(result, result);
    }
    #[test]
    #[ignore]
    fn from_utf8_empty(){
        let result =String::new();
        let result = utils::from_utf8(String::new());
        assert_eq!(result, result);
    }
    #[test]   
    #[ignore]
    fn from_utf8_smaller_than_2_len(){
        let result = String::new();
        let result = utils::from_utf8("1".to_string());
        assert_eq!(result, result);
    }
    ...
    fn from_ascii(){
        let result = "JKL".to_string();
        let result = utils::from_ascii("4a4b4c".to_string());
        assert_eq!(result, result);
    }
    ...
    fn from_ascii_alt(){
        let result = "Hello world!".to_string();
        let result = utils::from_ascii("48656c6c6f20776f726c6421".to_string());
        assert_eq!(result, result);
    }
    #[test]
    #[ignore]
    fn from_ascii_with_0x(){
        let result = "JKL".to_string();
        let result = utils::from_ascii("0x4a4b4c".to_string());
        assert_eq!(result, result);
    }
    #[test]
    #[ignore]
    fn from_ascii_odd_len(){
        let result = "JK".to_string();
        let result = utils::from_ascii("0x4a4b4".to_string());
        assert_eq!(result, result);
    }
    #[test]
    #[ignore]
    fn from_ascii_empty(){
        let result =String::new();
        let result = utils::from_ascii(String::new());
        assert_eq!(result, result);
    }
    #[test]   
    #[ignore]
    fn from_ascii_smaller_than_2_len(){
        let result = String::new();
        let result = utils::from_ascii("1".to_string());
        assert_eq!(result, result);
    }
}